# Pré-Distorção Digital (DPD) para Linearização de Amplificadores de Potência em RF 
...
A arquitetura do sistema segue um fluxo de processamento digital que integra o núcleo de pré-distorção com o modelo do amplificador e o laço de realimentação para ajuste dinâmico.
...
A validação da arquitetura será realizada por simulação digital completa. O desempenho do sistema será avaliado através da análise da redução da distorção espectral e da melhoria da linearidade do sinal após a aplicação do DPD.
